...
def process_data(data):
    ...
    BTC_CSV_PATH_1H = "/Users/narayan/Finance/INTER 13.0/BTC_CSV_PATH_1H"
    ETH_CSV_PATH_1H = "/Users/narayan/Finance/INTER 13.0/ETH_CSV_PATH_1H"
...
def strat(data):
    ...
    MAX_HOLDING_PERIOD = 14 * 24    # 2 weeks in hours
...
def perform_backtest(csv_file_path):
    ...
    result = client.backtest(
        jupyter_id="your_id_here",  # the one you use to login to jupyter.untrade.io
...
def main():
    ...
    # Set file paths here
    BTC_CSV_PATH_1H = "BTC_1H_CSV_INPUT_PATH"
    ETH_CSV_PATH_1H = "ETH_1H_CSV_INPUT_PATH"
    ...
    csv_file_path = "STRATEGY_RESULTS_CSV_OUTPUT_PATH"
